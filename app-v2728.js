...
// ================================================================
// V27.2.8 · Simulación segura + copia automática antes del cierre
...
async function createFullBackup(){
  ...
  try{
    ...
    const backup={application:"CD San Bernabé Manager",version:"V27.2.8",created_at:new Date().toISOString(),tables:{}};
