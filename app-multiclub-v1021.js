// MANAGER MULTICLUB · BUILD V1.0.21 · Patrocinio con historial real de pagos
...
rPitches.onclick=()=>downloadCSV("pistas.csv",pitchUsage.map(x=>({Fecha:x.usage_date,Hora:x.usage_time||"",EquipoEntidad:x.team_name,Tipo:x.usage_type,Campo:x.field_name,Importe:x.amount,Estado:pitchIsCancelled(x)?"Anulado":"Activo",Origen:"Manual"})));
