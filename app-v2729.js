...
// ================================================================
// V27.2.9 · Desplazamiento independiente y diálogos con scroll vertical
...
async function createFullBackup(){
  ...
  try{
    ...
    const backup={application:"CD San Bernabé Manager",version:"V27.2.9",created_at:new Date().toISOString(),tables:{}};
