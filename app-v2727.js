...
// ================================================================
// V27.2.7 · Revisión final de cambio anual corregida
...
async function createFullBackup(){
  ...
  try{
    ...
    const backup={application:"CD San Bernabé Manager",version:"V27.2.7",created_at:new Date().toISOString(),tables:{}};
