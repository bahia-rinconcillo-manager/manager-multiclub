...
const MULTICLUB_BUILD_VERSION="V1.0.39";
...
async function loadAll(){
  ...
  const queries=await Promise.allSettled([
    ...
    sb.from("events").select("id,title,event_type,event_date,event_time,team_name,location,description").order("event_date"),
...
async function refreshTableV1036(table){
  ...
  else if(table==="events")q=sb.from("events").select("id,title,event_type,event_date,event_time,team_name,location,description").order("event_date");
