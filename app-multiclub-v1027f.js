...
const MULTICLUB_BUILD_VERSION="V1.0.27F";
...
function renderPlayers(){
    ...
    return `<article class="player-professional-card" data-open-player-record="${p.id}" data-season-readonly-allow="true">
      ...
      <div class="player-card-main">
        ...
        <div class="player-card-footer">
          ...
          <button class="mini" type="button" data-open-player-record="${p.id}" data-season-readonly-allow="true">Abrir ficha</button>
        </div>
      </div>
    </article>`;
  ...
  tableBody.innerHTML=list.length?list.map(p=>{
    ...
    return `<tr>
      ...
      <td><button class="mini" type="button" data-open-player-record="${p.id}" data-season-readonly-allow="true">Abrir</button></td>
    </tr>`;
