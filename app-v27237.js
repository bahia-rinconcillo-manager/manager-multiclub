...
function renderDashboardMatches(){
  ...
  const card=m=>{
    ...
    const score=done?`${esc(m.goals_for)} - ${esc(m.goals_against)}`:"PENDIENTE";
    return `<article class="dashboard-match-item ${home?"is-home":"is-away"}">
      ...
      <div class="dashboard-match-body">
        ...
        <div class="dashboard-match-versus"><strong>${esc(homeName||"Equipo")}</strong><b>VS</b><strong>${esc(awayName||"Rival")}</strong></div>
