// MANAGER MULTICLUB · BUILD V1.0.16 · Pistas manuales sin campos ni tarifas predefinidos
...
rPitches.onclick=()=>downloadCSV("pistas.csv",pitchUsage.map(x=>({Fecha:x.usage_date,Hora:x.usage_time||"",Equipo:x.team_name,Tipo:x.usage_type,Campo:x.field_name,Importe:x.amount,Estado:pitchIsCancelled(x)?"Anulado":"Activo",Origen:"Manual"})));
