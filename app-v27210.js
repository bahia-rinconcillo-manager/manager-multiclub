...
async function saveRivalTeamForm(e){
  ...
  let crest=id?rivalTeams.find(r=>r.id===id)?.crest||"":"";
  if(file){
  ...
  resetRivalTeamForm();renderRivalTeams();populateOpponentSelect();toast(id?"Equipo actualizado":"Equipo rival añadido");
}
