...
function renderPitches(){
 const ym=pitchMonth.value||"",tf=pitchTeamFilter.value;
 pitchTeamFilter.innerHTML='<option value="">Todos los equipos</option>'+sortTeamsAlpha(teams).map(t=>`<option>${t.name}</option>`).join("");pitchTeamFilter.value=tf;
