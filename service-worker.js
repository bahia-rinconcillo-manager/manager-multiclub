const APP_CACHE = "manager-multiclub-app-v1-0-42";
...
const CORE_FILES = [
  ...
  "./app-multiclub-v1042.js?v=1042",
  "./rival-crests-v1041-multiclub.js?v=1041",
...
self.addEventListener("install",event=>{
  event.waitUntil(caches.open(APP_CACHE).then(async cache=>{
    ...
    if(failed)console.warn(`Manager Multiclub V1.0.42: ${failed} recursos se cargarán bajo demanda.`);
  }));
  self.skipWaiting();
});
